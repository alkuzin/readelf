...
pub struct Elf32_Phdr {
    ...
    /// congruent values for p_vaddr and p_offset, modulo the page size. This member gives the
    /// value to which the segments are aligned in memory and in the file. Values 0 and 1 mean
...
/// The array element is unused; other members’ values are undefined. This type lets the program
/// header table have ignored entries.
pub const PT_NULL: u32 = 0;
/// The array element specifies a loadable segment, described by `p_filesz` and `p_memsz`.
/// The bytes from the file are mapped to the beginning of the memory segment. If the segment’s
...
/// The array element specifies dynamic linking information. See "Dynamic Section" below for
/// more information.
...
/// The array element specifies the location and size of auxiliary information. See "Note Section"
/// below for details.
