...
/// index is a subscript into this array. Index 0 both designates
...
pub struct Elf32_Sym {
    ...
    /// the value is non-zero, it represents a string table index that
    /// gives the symbol name. Otherwise, the symbol table entry has no
    /// name.
    pub st_name: Elf32_Word,
    /// This member gives the value of the associated symbol. Depending on the
    /// context, this may be an absolute value, an address, etc.; details
    /// appear below.
    pub st_value: Elf32_Addr,
    /// Many symbols have associated sizes. For example, a data object’s size
    /// is the number of bytes contained in the object. This member holds 0
...
/// associated with the object file. A file symbol has STB_LOCAL binding, its
/// section index is SHN_ABS, and it precedes the other STB_LOCAL symbols for
